...
import { faPhone, faCopy, faCalendarAlt } from "@fortawesome/free-solid-svg-icons";
                ...
                <>
                    <div className={styles.vHeader}>
                        <div className={styles.title}>
                            <p> Visit - Visit Date</p>
                            <p><span><FontAwesomeIcon icon={faCalendarAlt} /></span> {visitData.created_at}</p>
                        </div>
                        <div className={styles.title}>
                    ...
                    <div className={styles.components}>
                        ...
                        <div className={styles.medicine}>
                            ...
                            <div>
                                ...
                                <label for="green-toggle" className="inline-flex relative items-center mr-5 cursor-pointer">
                                    ...
                                    <span className="ml-3 text-sm font-medium text-gray-900 dark:text-gray-300">Sold to Patient</span>
                                </label>
                            </div>
                            <div>
                        ...
                        <div>
                            <div>
                                <label for="message" className="block mb-2 text-md font-medium text-gray-900 dark:text-gray-400">Tests</label>
                                <textarea id="message" rows="5" className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 cursor-not-allowed" placeholder="Please Dr. leave your comments here..." value={visitData.test} disabled></textarea>
                                <label className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300" for="user_avatar">Tests Results</label>
                            ...
                            <div>
                                <label for="message" className="block mb-2 text-md font-medium text-gray-900 dark:text-gray-400">X-Rays</label>
                                <textarea id="message" rows="5" className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 cursor-not-allowed" placeholder="Please Dr. leave your comments here..." value={visitData.x_rays} disabled></textarea>
                                <label className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300" for="user_avatar">Xray Results</label>
                                <input className="block w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 cursor-pointer dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" aria-describedby="user_avatar_help" id="user_avatar" type="file" />
                            </div>
                        </div>
                    </div>
