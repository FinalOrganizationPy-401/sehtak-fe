...
export default function XraysVisit({visitData}) {

    const [links, setLinks] = useState([])
    const router = useRouter()
    const visitUpdateUrl ="http://sehtak.herokuapp.com/api/v1/visits/"+visitData.id+"/"
                        ...
                        {/* <div className='mb-5'>
                            ...
                            <div id="message" rows="9" class="mb-3 overflow-y-auto h-36 block p-2.5 w-full text-lg text-gray-900 bg-gray-50 rounded-lg border border-gray-30 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white" >{visitData.test? visitData.test : "there is no tests provided yet"}</div>
                                ...
                                <div className='flex justify-around'>
                                    <input name='tests_files' class="block w-96 text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 cursor-pointer dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" aria-describedby="user_avatar_help" id="user_avatar" type="file"/>
                            ...
                            <div>
                                ...
                                <div id="message" rows="9" class="mb-3 overflow-y-auto h-36 block p-2.5 w-full text-lg text-gray-900 bg-gray-50 rounded-lg border border-gray-30 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white" >{visitData.x_rays? visitData.x_rays : "there is no X-ray provided yet"}</div>
