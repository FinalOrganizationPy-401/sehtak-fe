        ...
        <>  {!patientData ?
            ...
            <div className='profile'>
                <div className='flex justify-between my-4 mb-6'>
                    <span className={styles.name}>Hello {patientData?.first_name} {patientData?.last_name} </span>
                    <Link href="UserEditData"><span className={styles.editButton}>Edit</span></Link>
                </div>
                <hr />
                <div className='mt-3 ml-5'><span className=''> Phone Number: </span>
                    <span className='font-medium text-sky-600'> {patientData?.phone} </span>
                </div>
